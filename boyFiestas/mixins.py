...
def FormErrors(*args):
	'''
	Gestiona los errores de los formularios que se devuelven a las llamadas AJAX.
	'''
	message = ""
	for f in args:
		if f.errors:
...
def RedirectParams(**kwargs):
	'''
	Se utiliza para añadir los parámetros de la url cuando se redirige a los usuarios.
	'''
	url = kwargs.get("url")
...
class AjaxFormMixin(object):
	...
	'''
	Mixin para ajaxificar el formulario de django - puede ser sobreescrito en la vista llamando al método form_valid.
	'''
...
def Directions(*args, **kwargs):
	'''
	Maneja las direcciones de Google.
	'''
